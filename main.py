...
def main():
    ...
    if not os.path.exists(TRAIN_PATH) or not os.path.exists(VAL_PATH) or not os.path.exists(TEST_PATH):
        ...
        trainer = TransferLearning(
            ...
            k_folds=5,
            lr_patience=10,
            models_dir= f"keras_training/keras_models_{DATE}_{args.unfreeze}_unfreeze",
            results_dir=f"keras_training/keras_models_{DATE}_{args.unfreeze}_unfreeze_performances_and_history",
            image_size=(96, 96),
