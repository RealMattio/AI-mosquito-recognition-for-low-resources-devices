...
if __name__ == "__main__":
    ...
    # python calculate_performance_variation.py keras_training/keras_models_1108_performances_and_history/evaluation_metrics_MobileNet_ClassicDenseClassifier.json tflite_models/tflite_models_1108/evaluation_MobileNet_ClassicDenseClassifier_final_model.json tflite_models/tflite_models_1108/variation_MobileNet.json
    # python calculate_performance_variation.py keras_training/keras_models_1108_performances_and_history/evaluation_metrics_MobileNetV2_ClassicDenseClassifier.json tflite_models/tflite_models_1108/evaluation_MobileNetV2_ClassicDenseClassifier_final_model.json tflite_models/tflite_models_1108/variation_MobileNetV2.json
    # python calculate_performance_variation.py keras_training/keras_models_1108_performances_and_history/evaluation_metrics_NASNetMobile_ClassicDenseClassifier.json tflite_models/tflite_models_1108/evaluation_NASNetMobile_ClassicDenseClassifier_final_model.json tflite_models/tflite_models_1108/variation_NASNetMobile.json
    # python calculate_performance_variation.py keras_training/keras_models_1108_performances_and_history/evaluation_metrics_ResNet50_ClassicDenseClassifier.json tflite_models/tflite_models_1108/evaluation_ResNet50_ClassicDenseClassifier_final_model.json tflite_models/tflite_models_1108/variation_ResNet50.json